...
namespace AnotherEdit
{
    class DataBaseCommon
    {
        ...
        public DataSet GetDataSet(StringBuilder sbSql, string providerName, string connectionString, out string strError, out int intEffected)
        {
            intEffected = -1;
            strError = "";
        ...
        // Load DataBase Providers on current PC
        public void LoadProviders(ref System.Windows.Controls.ComboBox comboProviders)
        {
            // Retrieve the installed providers and factories.
            DataTable table = DbProviderFactories.GetFactoryClasses();
